...
export function DocumentsList() {
  ...
  const openDocument = (id) => navigate(`/documents/${id}`);
    ...
    <div className="p-6 md:p-8 space-y-6 max-w-7xl mx-auto flex flex-col h-full">
      <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">All processed documents. Open one to view its artifacts and assessment.</p>
        </div>
                      ...
                      <div className="flex items-center justify-end gap-2">
                        ...
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end">
                            <DropdownMenuItem onClick={() => openDocument(doc.id)}>
                              Open details
                            </DropdownMenuItem>
                            <DropdownMenuItem
