  ...
  return (
    <div className="flex h-screen overflow-hidden bg-background font-sans">
        ...
        {mobileMenuOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-0 left-0 bottom-0 w-72 bg-background border-r-2 border-foreground z-50 md:hidden flex flex-col shadow-xl"
            >
              {/* Header inside mobile menu */}
              <div className="h-16 flex items-center justify-between px-6 border-b-2 border-foreground shrink-0 bg-card">
                ...
                <div className="p-4 border-t-2 border-foreground bg-card">
                  <div className="flex items-center justify-between gap-2">
                    <div className="min-w-0 leading-tight">
                      ...
                      {auth.user.email && <div className="truncate text-xs text-muted-foreground">{auth.user.email}</div>}
                      <div className="truncate text-xs text-muted-foreground capitalize">{auth.roles.join(', ')}</div>
                    </div>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        {/* Topbar */}
        {(
          <header className="h-16 border-b-2 border-foreground bg-background flex items-center justify-between px-6 shrink-0 z-10 print-hide">
