...
export function HeroSection() {
  ...
  return (
    <section className="relative w-full bg-background py-20 md:py-32 px-4 md:px-8 overflow-hidden min-h-[600px] flex items-center">
      ...
      <div className="max-w-[1200px] mx-auto w-full relative z-10 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-6 md:space-y-8 flex flex-col items-start text-left max-w-[560px]">
          <h1 className="font-serif text-[32px] md:text-[48px] font-normal text-foreground tracking-tight leading-[1.1] select-none">
          ...
          <div className="flex flex-wrap items-center gap-3 w-full sm:w-auto">
            <button
              ...
              className="w-full sm:w-auto h-11 px-6 bg-primary hover:bg-primary/90 text-primary-foreground rounded-[8px] font-sans text-sm font-semibold tracking-wide transition-colors duration-150 flex items-center justify-center gap-1.5 shadow-sm"
            >
            ...
            <button
              ...
              className="w-full sm:w-auto h-11 px-6 bg-background border border-border text-foreground hover:bg-accent rounded-[8px] font-sans text-sm font-semibold tracking-wide transition-colors duration-150 flex items-center justify-center"
            >
              Learn More
            </button>
          </div>
